...
export const BOSS_DATA: Boss[] = [
  ...
  { name: '伊弗利特', respawnHours: 2, aliases: ['伊弗利特','伊佛', 'EF', 'ef'] },
  { name: '大黑長者', respawnHours: 3, aliases: ['大黑長者','大黑'] },
  { name: '暗黑長者', respawnHours: 6, aliases: [] },
  { name: '巨大飛龍', respawnHours: 6, aliases: ['巨大飛龍','巨飛'] },
  ...
  { name: '變形怪首領', respawnHours: 7, aliases: ['變形怪首領','變怪'] },
  ...
  { name: '死亡騎士', respawnHours: 4, aliases: ['死亡騎士','死騎'] },
  { name: '力卡溫', respawnHours: 8, aliases: ['狼王'] },
  { name: '克特', respawnHours: 10, aliases: [] },
  { name: '古代巨人', respawnHours: 8.5, aliases: ['古代巨人','古巨'] },
  { name: '賽尼斯的分身', respawnHours: 3, aliases: ['賽尼斯', '賽老師'] },
  { name: '卡司特王', respawnHours: 7.5, aliases: ['卡司特王','卡王'] },
  { name: '樹精', respawnHours: 3, aliases: [] },
  { name: '烏勒庫斯', respawnHours: 6, aliases: ['烏勒庫斯','烏王'] },
  { name: '奈克諾斯', respawnHours: 4, aliases: ['奈克諾斯','奈王'] },
  { name: '蜘蛛', respawnHours: 4, aliases: [] },
  { name: '巨大鱷魚', respawnHours: 3, aliases: ['巨鱷', '鱷魚'] },
  { name: '大腳瑪幽', respawnHours: 3, aliases: ['大腳瑪幽','大腳'] },
